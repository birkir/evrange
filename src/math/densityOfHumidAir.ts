...
const pressureWithDeltaHeight = (p0, T0, M, h) => {
...
export const densityOfHumidAir = (temperatureInCelcius, relativeHumidity, absoluteAirPressureInPascal, heightAboveReference) => {
