export const inverterConsumption = (consumptionFromRollingResistance: number, consumptionFromWindDrag: number, consumptionFromMotor: number, dcToACInverterEfficiency: number = 0.95) => {
