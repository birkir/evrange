...
export const Consumption = types
  .model('Consumption', {
    // driving parameters
    speedInKmPerHour: 90,
    inclineInPercent: 0,
  ...
  .views(self => ({
    ...
    get airDensity() {
      return densityOfHumidAir(
        self.temperatureInCelcius,
        self.relativeHumidity,
        self.absoluteAirPressureInPascal,
        self.heightAboveReference
      );
    },
    get motorEfficiency() {
      return motorEfficiency(
        self.motorEfficiencyAtMax,
        self.motorEfficiencyAtMin,
        self.speedInKmPerHourAtMaxMotorEfficiency,
        self.speedInKmPerHour
      );
    },
    ...
    get windDragConsumption() {
      ...
      return windDragConsumption(
        self.dragCoefficient,
        self.dragReferenceAreaInSquareMeters,
        (self as any).airDensity,
        adjustedSpeed
      );
    },
    get motorConsumption() {
      return motorConsumption(
        ...
        (self as any).motorEfficiency
      );
    },
    get inverterConsumption() {
      return inverterConsumption(
        (self as any).rollingResistanceConsumption,
        (self as any).windDragConsumption,
        (self as any).motorConsumption,
        self.dcToACInverterEfficiency
      );
    },
    get batteryDischarge() {
      return batteryDischargeConsumption(
        (self as any).rollingResistanceConsumption,
        (self as any).windDragConsumption,
        (self as any).motorConsumption,
        (self as any).inverterConsumption,
        self.batteryDischargeEfficiency
      );
    },
    ...
    get totalConsumption() {
      return ((self as any).averageConsumption * self.distance) / 1000;
    },
  }));
